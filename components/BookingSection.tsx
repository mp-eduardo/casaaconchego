...
const BookingSection: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Reset form and provide feedback after a short delay, assuming mail client opened.
    // This is optimistic as we can't truly know if the mail client opened or email was sent.
    setTimeout(() => {
      setFormData({ name: '', email: '', message: '' });
      setFormErrors({});
      setIsSubmitting(false);
      setSubmitStatus('success'); // Assume success for opening mail client
    ...
    <section id="booking" className="py-16 md:py-24 bg-brand-primary text-white">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto mb-16">
          ...
          <a
            href={`mailto:${CONTACT_EMAIL}`} // Direct mailto link as fallback/alternative
