...
import { WifiIcon, SparklesIcon, BuildingStorefrontIcon, SunIcon, FireIcon, TvIcon, TruckIcon, UserGroupIcon, InboxStackIcon } from '@heroicons/react/24/outline'; // Corrected import path
